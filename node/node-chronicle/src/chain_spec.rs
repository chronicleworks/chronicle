...
use runtime_chronicle::{
	opaque::SessionKeys, pallet_chronicle, AccountId, AuraConfig, GrandpaConfig, ImOnlineConfig,
	Runtime, RuntimeGenesisConfig, SessionConfig, Signature, SudoConfig, SystemConfig,
...
pub fn authority_keys_from_keystore(
	p: &std::path::Path,
...
pub fn chronicle_config() -> Result<ChainSpec, String> {
	...
	let (root_key, aura_key, grandpa_key, im_online_key) =
		authority_keys_from_keystore(Path::new("/keystore/"));
