...
impl Store {
    ...
    pub fn populate_prov_model_for_activity(
        ...
        use schema::{
            ...
            generation::dsl as generation_dsl,
            usage::dsl as usage_dsl,
            wasinformedby::dsl as wasinformedby_dsl,
            association::dsl as association_dsl,
            entity::dsl as entity_dsl,
            agent::dsl as agent_dsl,
            activity::dsl as activity_dsl,
        };
        ...
        let (generations, usages, wasinformedbys, associations): (Generations, Usages, WasInformedBys, Associations) = (
            ...
            wasinformedby_dsl::wasinformedby
                ...
                .inner_join(activity_dsl::activity.on(wasinformedby_dsl::informing_activity_id.eq(activity_dsl::id)))
